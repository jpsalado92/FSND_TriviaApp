...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_404_sent_requesting_non_existing_category_questions(self):
    ...
    def test_422_sent_deleting_non_existing_question(self):
        res = self.client().delete("/questions/e")
        data = json.loads(res.data)
    ...
    def test_add_question_with_no_answer(self):
        new_question = {
            "question": "question",
            "answer": None,
            "difficulty": 1,
    ...
    def test_add_question_with_no_text(self):
        new_question = {
            "question": None,
            "answer": "answer",
            "difficulty": 1,
    ...
    def test_play_quiz_2(self):
        new_quiz_round = {"previous_questions": [1, 2, 3],
                          "quiz_category": {"type": "Entertainment", "id": "5"}}
        res = self.client().post("/quizzes", json=new_quiz_round)
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
